                ...
                <ul class="navbar-nav mr-auto">
                    ...
                    @if( Auth::user()->role->id == 2 )
                        <li class="nav-item dropdown">
                            <a target="_blank" class="nav-link" href="https://www.asf.gob.mx/Default/Index">
                    ...
                    @if( Auth::user()->role->id == 2 )
                        <li class="nav-item dropdown">
                            <a target="_blank" class="nav-link" href="https://www.asf.gob.mx/Section/105_ICADEFIS">
                            ICADEFIS
                            </a>
                        </li>
                    @endif
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-right dropdown-default" aria-labelledby="navbarDropdownMenuLink-333">
                        ...
                        <form class="form-inline" id="logout-form" action="{{ route('logout') }}" method="POST">
                            @csrf
                                <button type="submit" style="border: 0; text-decoration: none;">
